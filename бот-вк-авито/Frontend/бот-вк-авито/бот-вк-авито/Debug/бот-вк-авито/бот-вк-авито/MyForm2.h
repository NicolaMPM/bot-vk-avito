...
namespace InterfaceMyFormTwo {
	...
	public:
		System::Collections::Generic::Stack<Thread^>^ Multizering() {
			...
			Thread^ potocSpawnMessageVk = gcnew Thread(gcnew ThreadStart(myform, &InterfaceMyFormTwo::MyForm2::vhodVVK));
			System::Collections::Generic::Stack<Thread^>^ massThread = nullptr;
			Thread^ potocSpawnMessageAvito = gcnew Thread(gcnew ThreadStart(myform, &InterfaceMyFormTwo::MyForm2::vhodVAvito));
			Thread^ potocExportDataVK = gcnew Thread(gcnew ThreadStart(myform, &InterfaceMyFormTwo::MyForm2::vhodExportVK));
			Thread^ potocExportDataAvito = gcnew Thread(gcnew ThreadStart(myform, &InterfaceMyFormTwo::MyForm2::vhodExportAvito));
...
#pragma endregion
	...
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		InterfaceMyFormTwo::SearchDBAvito = this->preob(SearchDBAvito);
	}
};
}
